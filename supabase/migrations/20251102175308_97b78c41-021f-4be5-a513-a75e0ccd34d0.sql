-- Update the validate_patient_data function to allow empty CPF when no_nfse is true
...
AS $function$
BEGIN
  -- If no_nfse is true, skip all CPF validations
  IF NEW.no_nfse = true THEN
    -- Just sanitize text fields and return
