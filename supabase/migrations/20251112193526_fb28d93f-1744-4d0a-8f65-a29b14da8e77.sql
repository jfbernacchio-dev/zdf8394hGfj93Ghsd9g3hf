-- Atualizar trigger handle_new_user para lidar com CPF e CRP nullable
...
BEGIN
  ...
  VALUES (
    ...
    NULLIF(NEW.raw_user_meta_data->>'cpf', ''), -- NULL se string vazia
    NULLIF(NEW.raw_user_meta_data->>'crp', ''), -- NULL se string vazia
