/**
 * 🥧 GRÁFICO DE DISTRIBUIÇÕES ADMINISTRATIVAS
 * 
 * Reutiliza a visualização de distribuição de sessões com contexto administrativo.
...
export function AdminDistributionsChart({ 
  summary,
  isLoading, 
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Distribuição por status (contexto administrativo) • Total: {summary.totalSessions} sessões
        </CardDescription>
      </CardHeader>
      <CardContent>
