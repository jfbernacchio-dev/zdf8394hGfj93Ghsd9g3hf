...
export function MetricsWebsiteConversionCard({ isLoading, className }: MockMetricsCardProps) {
  if (isLoading) {
    return (
  ...
  return (
    <Card className={className}>
      <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        <CardTitle className="text-sm font-medium">Conversão (exemplo)</CardTitle>
