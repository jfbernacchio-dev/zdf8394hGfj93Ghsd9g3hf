           ...
           <TabsContent value="overview" className="space-y-6">
             ...
             <div className="mt-4">
               <GridCardContainer
                 ...
                 layout={overviewLayout['patient-overview-main']?.cardLayouts || []}
                 onLayoutChange={(newLayout) => {
                   updateOverviewLayout('patient-overview-main', newLayout);
                 }}
                 isEditMode={isOverviewLayoutEditMode}
                 width={1200}
               >
                 {(overviewLayout['patient-overview-main']?.cardLayouts || []).map((cardLayout) => (
