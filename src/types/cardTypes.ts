...
export const AVAILABLE_STAT_CARDS: CardConfig[] = [
  ...
  // Evolution Charts (12 clinical metric charts)
  {
    id: 'chart-consciousness',
    name: 'Consciência',
    description: 'Evolução do nível e campo de consciência',
    detailedDescription: 'Gráfico de linha mostrando a evolução temporal do nível de consciência (de coma a confusão) e campo de consciência (estreitamento a expansão caótica). Útil para acompanhar alterações de vigilância, atenção e percepção do ambiente ao longo do tratamento.',
    category: 'statistics',
    defaultWidth: 590,
    defaultHeight: 320,
  },
  {
    ...
    detailedDescription: 'Gráfico de pizza mostrando a distribuição dos tipos de desorientação (temporal, espacial, autopsíquica, alopsíquica) e alterações do juízo de realidade registradas nas avaliações.',
    category: 'statistics',
    defaultWidth: 590,
    defaultHeight: 320,
  },
  {
    id: 'chart-memory',
    name: 'Memória',
    description: 'Desempenho médio por tipo de memória',
    detailedDescription: 'Gráfico radar mostrando o desempenho em diferentes tipos de memória: fixação, evocação, reconhecimento, memória remota. Permite visualizar rapidamente quais funções mnêmicas estão preservadas ou comprometidas.',
    category: 'statistics',
    defaultWidth: 590,
    defaultHeight: 320,
  },
  {
    ...
    detailedDescription: 'Linha temporal mostrando as variações de humor de deprimido (-100) a eufórico (+100), passando por eutimia (0). Essencial para acompanhar transtornos de humor e eficácia do tratamento.',
    category: 'statistics',
    defaultWidth: 590,
    defaultHeight: 320,
  },
  {
    id: 'chart-thought',
    name: 'Pensamento',
    description: 'Curso do pensamento ao longo do tempo',
    detailedDescription: 'Gráfico de linha mostrando velocidade do pensamento, de lentificado (-100) a fuga de ideias (+100). Importante para transtornos do espectro bipolar e depressivos.',
    category: 'statistics',
    defaultWidth: 590,
    defaultHeight: 320,
  },
  {
    ...
    detailedDescription: 'Evolução do ritmo da fala, de bradilalia (lentificação, -100) a taquilalia (aceleração, +100). Correlaciona com alterações de pensamento e humor.',
    category: 'statistics',
    defaultWidth: 590,
    defaultHeight: 320,
  },
  {
    ...
    name: 'Sensopercepção',
    description: 'Tipos de alteração perceptiva no período',
    detailedDescription: 'Gráfico de pizza mostrando distribuição de ilusões e alucinações (auditivas, visuais, táteis, olfativas, cinestésicas) registradas. Fundamental para transtornos psicóticos.',
    category: 'statistics',
    defaultWidth: 590,
    defaultHeight: 320,
  },
  {
    ...
    detailedDescription: 'Radar com avaliação de diferentes domínios cognitivos: raciocínio abstrato, compreensão, crítica, juízo. Permite identificar déficits específicos ou globais.',
    category: 'statistics',
    defaultWidth: 590,
    defaultHeight: 320,
  },
  {
    ...
    detailedDescription: 'Duas linhas mostrando energia volitiva (de abulia a hiperbulia) e controle de impulsos. Importante para transtornos de personalidade e dependências.',
    category: 'statistics',
    defaultWidth: 590,
    defaultHeight: 320,
  },
  {
    ...
    description: 'Tônus psicomotor ao longo do tempo',
    detailedDescription: 'Linha temporal do tônus psicomotor, de inibição/estupor (-100) a agitação psicomotora (+100). Correlaciona com estados depressivos, maníacos e ansiosos.',
    category: 'statistics',
    defaultWidth: 590,
    defaultHeight: 320,
  },
  {
    ...
    detailedDescription: 'Evolução da capacidade atencional, de aprosexia (0) a hiperprosexia (100). Fundamental para TDAH e transtornos ansiosos.',
    category: 'statistics',
    defaultWidth: 590,
    defaultHeight: 320,
  },
  {
    ...
    detailedDescription: 'Duas linhas acompanhando a coerência da identidade pessoal e estabilidade emocional ao longo do tratamento. Essencial para transtornos de personalidade.',
    category: 'statistics',
    defaultWidth: 590,
    defaultHeight: 320,
  },
